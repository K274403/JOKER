...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002617794966 -1001767486774 -1002192042126').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003125469666'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003125469666'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002265223323'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003125469666'))  
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002023191399') 
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Deepak")
...
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/rkmoviezip')
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002263971223'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002263971223'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/HgBotz-07-14")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/KRISHFILMY/1860")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/")

SHORTENER_API = environ.get("SHORTENER_API", "99d89644e3049653b4b838934bf78d1b6024472d")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "shortxlinks.com")

SHORTENER_API2 = environ.get("SHORTENER_API2", "99d89644e3049653b4b838934bf78d1b6024472d")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shortxlinks.com")

SHORTENER_API3 = environ.get("SHORTENER_API3", "99d89644e3049653b4b838934bf78d1b6024472d")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/rkmoviezip') 
